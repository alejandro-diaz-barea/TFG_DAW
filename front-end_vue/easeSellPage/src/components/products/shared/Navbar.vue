<template>
    <header class="header">
      <router-link to="/" class="header__logo-link">
        <p class="header__logo-link_name">
          <span class="header__logo-link_name_bold">Ease</span>Sell
        </p>
      </router-link>
      <nav class="header__nav">
        <ul class="nav__list">
          <li class="nav__item">
            <router-link to="/products" class="nav__link">explore</router-link>
          </li>
          <li class="nav__item">
            <router-link to="/sell" class="nav__link">sell</router-link>
          </li>
          <li class="nav__item">
  ...
  <style scoped>
  header.header {
    background-color: rgba(39, 110, 144, 0.4); 
    color: #000000;
    padding-top: 0.75rem;
  ...
  .header__logo-link_name {
    font-size: 2rem;
    color: black;
  }
  
  .header__logo-link_name_bold{
    font-weight: bold;
